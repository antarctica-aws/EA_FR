...
product = 'GEDI02_A.002'           # Options include 'GEDI01_B.002', 'GEDI02_A.002', 'GEDI02_B.002'   ####!!![need to modify]!!!###
bbox = '-124.4820168611238103, 32.5288367369123819,-114.1312224747231312,42.0095222696210868'  ####!!![need to modify]!!!###  
...
outName =f"ca_state_{product.replace('.', '_')}_GranuleList_{datetime.now().strftime('%Y%m%d%H%M%S')}_v2.txt"  ####!!![need to modify]!!!###
