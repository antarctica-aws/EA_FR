...
poly <- readOGR('AOI/HASHI/hashi_east.geojson')
...
for (pred_year in 2021:1986){
  ...
  # annual_ras2 <- raster(paste('agbd_predictions/shinyanga2_ts_out/agbd_', pred_year,'_xgboost_sqrt_nbr_lhs_33_', pattern,'_ls_lhs_medoid_',tile,'_', pred_year,'_NBR_3by3_dur8_biome1_val_v2-0000005120-0000000000.tif', sep=''))
...
write.csv( tile_agbd_by_manage, paste("agbd_predictions/shinyanga1_ts_out/agbd_collrm_by_planting_px",
                                      pattern,"_HASHI_east_covar.csv", sep=""))
