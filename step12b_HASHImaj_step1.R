...
poly <- readOGR('AOI/HASHI/HASHI_ANR.shp')
...
ras_temp <-  raster(paste('agbd_predictions/shinyanga2_ts_out/agbd_2021_xgboost_sqrt_nbr_lhs_33_', pattern,'_ls_lhs_medoid_',tile,'_2021_NBR_3by3_dur8_biome1_val_v2-0000002560-0000000000.tif', sep=''))
...
for (pred_year in 2021:1986){
  ...
  annual_ras1 <- raster(paste('agbd_predictions/shinyanga2_ts_out/agbd_', pred_year,'_xgboost_sqrt_nbr_lhs_33_', pattern,'_ls_lhs_medoid_',tile,'_', pred_year,'_NBR_3by3_dur8_biome1_val_v2-0000000000-0000002560.tif', sep=''))
  annual_ras2 <- raster(paste('agbd_predictions/shinyanga2_ts_out/agbd_', pred_year,'_xgboost_sqrt_nbr_lhs_33_', pattern,'_ls_lhs_medoid_',tile,'_', pred_year,'_NBR_3by3_dur8_biome1_val_v2-0000000000-0000000000.tif', sep=''))
  annual_ras3 <- raster(paste('agbd_predictions/shinyanga2_ts_out/agbd_', pred_year,'_xgboost_sqrt_nbr_lhs_33_', pattern,'_ls_lhs_medoid_',tile,'_', pred_year,'_NBR_3by3_dur8_biome1_val_v2-0000002560-0000000000.tif', sep=''))
...
write.csv( tile_agbd_by_manage, paste("agbd_predictions/shinyanga1_ts_out/agbd_collrm_by_planting_px",
                                      pattern,"_HASHI_maj_covar.csv", sep=""))
