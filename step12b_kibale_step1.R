...
poly <- readOGR('AOI/AMF_sites/ecotrust_mf_landscape.shp')
poly$PlantingYe <- '2006'



pattern <-'no5+beam+2sig_thre_tuned_dcol'    #'beam+2sig_no5_Sept_thre_tuned_dcol'

ras_temp <- raster(paste('agbd_predictions/kibale_ts_out/agbd_2021_xgboost_sqrt_nbr_lhs_33_tile_', pattern,'_ls_lhs_medoid_173060_2021_NBR_3by3_dur8_biome1-0000000000-0000005120.tif', sep=''))
...
for (pred_year in 2021:1986){   #1986
  ...
  if (pred_year < 2019  && pred_year>2015){
    annual_ras1 <- raster(paste('agbd_predictions/kibale_ts_out/agbd_', pred_year,'_xgboost_sqrt_nbr_lhs_33_tile_', pattern,'_ls_lhs_medoid_173060_', pred_year,'_NBR_3by3_dur8_biome1_val-0000000000-0000005120.tif', sep=''))
    annual_ras2 <- raster(paste('agbd_predictions/kibale_ts_out/agbd_', pred_year,'_xgboost_sqrt_nbr_lhs_33_tile_', pattern,'_ls_lhs_medoid_173060_', pred_year,'_NBR_3by3_dur8_biome1_val-0000002560-0000005120.tif', sep=''))
    
  } else if (pred_year<=2015){
    annual_ras1 <- raster(paste('agbd_predictions/kibale_ts_out/agbd_', pred_year,'_xgboost_sqrt_nbr_lhs_33_tile_', pattern,'_ls_lhs_medoid_173060_', pred_year,'_NBR_3by3_dur8_biome1_val_v2-0000000000-0000005120.tif', sep=''))
    annual_ras2 <- raster(paste('agbd_predictions/kibale_ts_out/agbd_', pred_year,'_xgboost_sqrt_nbr_lhs_33_tile_', pattern,'_ls_lhs_medoid_173060_', pred_year,'_NBR_3by3_dur8_biome1_val_v2-0000002560-0000005120.tif', sep=''))
    
    
  } else if (pred_year %in% c(2021,2020,2019)){
    annual_ras1 <- raster(paste('agbd_predictions/kibale_ts_out/agbd_', pred_year,'_xgboost_sqrt_nbr_lhs_33_tile_', pattern,'_ls_lhs_medoid_173060_', pred_year,'_NBR_3by3_dur8_biome1-0000000000-0000005120.tif', sep=''))
    annual_ras2 <- raster(paste('agbd_predictions/kibale_ts_out/agbd_', pred_year,'_xgboost_sqrt_nbr_lhs_33_tile_', pattern,'_ls_lhs_medoid_173060_', pred_year,'_NBR_3by3_dur8_biome1-0000002560-0000005120.tif', sep=''))
  }
