...
poly <- readOGR('AOI/AMF_sites/humbo_mf.geojson')
pattern <- 'tile+beam+21halfsig_sol_power_0801samp_thre_tuned_dcol'

ras_temp <-  raster(paste('agbd_predictions/sodo_ts_out/agbd_2021_xgboost_sqrt_nbr_lhs_33_', pattern,'_ls_lhs_medoid_169055_2021_NBR_3by3_dur8_biome1_val_v2-0000002560-0000005120.tif', sep=''))
...
for (pred_year in 2021:1986){
  ...
  annual_ras1 <- raster(paste('agbd_predictions/sodo_ts_out/agbd_', pred_year,'_xgboost_sqrt_nbr_lhs_33_', pattern,'_ls_lhs_medoid_169055_', pred_year,'_NBR_3by3_dur8_biome1_val_v2-0000002560-0000005120.tif', sep=''))
  annual_ras2 <- raster(paste('agbd_predictions/sodo_ts_out/agbd_', pred_year,'_xgboost_sqrt_nbr_lhs_33_', pattern,'_ls_lhs_medoid_169055_', pred_year,'_NBR_3by3_dur8_biome1_val_v2-0000005120-0000005120.tif', sep=''))
...
write.csv( tile_agbd_by_manage, paste("agbd_predictions/AMF_sites_df/humbo_mf_agbd_collrm_by_planting_px",
                                      pattern,"_covar.csv", sep=""))
